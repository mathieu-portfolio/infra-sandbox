...
// Compatibility umbrella for scenario data.
// Prefer including the narrower headers in gameplay/scenario/data/ when touching code.
...
#include "gameplay/scenario/data/ScenarioRegistry.hpp"
#include "gameplay/scenario/data/ScenarioRuntime.hpp"
