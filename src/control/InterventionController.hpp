...
public:
    void handleActions(std::span<const InputEvent> events, Simulation& simulation, ScenarioManager& scenarioManager, UiState& uiState);
...
private:
    ...
    void confirmPlacement(Simulation& simulation, ScenarioManager& scenarioManager, UiState& uiState) const;
