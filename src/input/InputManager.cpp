...
InputMap::InputMap()
{
    bindings_ = {
        ...
        {InputAction::AddCache, InputDevice::Keyboard, KEY_SEVEN, InputTrigger::Pressed},
        {InputAction::AddReadReplica, InputDevice::Keyboard, KEY_EIGHT, InputTrigger::Pressed},
        {InputAction::AddQueue, InputDevice::Keyboard, KEY_NINE, InputTrigger::Pressed},
        {InputAction::AddRegionalCache, InputDevice::Keyboard, KEY_ZERO, InputTrigger::Pressed},
        {InputAction::PreviousPlacementCandidate, InputDevice::Keyboard, KEY_LEFT, InputTrigger::Pressed},
        {InputAction::NextPlacementCandidate, InputDevice::Keyboard, KEY_RIGHT, InputTrigger::Pressed},
        {InputAction::ConfirmPlacement, InputDevice::Keyboard, KEY_ENTER, InputTrigger::Pressed},
        {InputAction::CancelPlacement, InputDevice::Keyboard, KEY_BACKSPACE, InputTrigger::Pressed},
